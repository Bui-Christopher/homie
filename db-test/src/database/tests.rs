...
/// Persistence that the test object mocks storing
...
/// Test object that mocks calling on different persistences
#[derive(Debug, Serialize, Deserialize)]
struct TestObject {}
...
#[test]
/// Test that instantiates an object and calls on different persistences
fn test_persistence() {
